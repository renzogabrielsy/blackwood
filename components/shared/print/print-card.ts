// ─────────────────────────────────────────────────────────────────────────────
// **PLATFORM COMPONENT (moved here 2026-09-16).** Born in
// `app/(app)/analytics/print-card.ts` and lived there while /analytics was the
// only printable surface; `/operations`' FED PRICE and ACTUAL FED PRICE modals
// are the second, so it moved to `components/shared/` — CLAUDE.md's layer rule.
// It carries ZERO tenant knowledge: no charcoal, no campaign, no Supabase, not
// even a notion of what a "card" contains — it is a DOM + `window.print()`
// mechanism and nothing else. The analytics path is now a one-line re-export,
// so not one of its three call sites moved.
// ─────────────────────────────────────────────────────────────────────────────
