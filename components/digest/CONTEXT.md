...
- **RC IN is a plain SUM, and it is bucketed in TypeScript** — because the
  canonical daily view (`view_digest_daily_flow`) is windowed to 120 days in
  SQL and cannot reach "this year", and because the by-supplier ranking has no
  SQL home at all: there is no per-supplier daily view, and **PostgREST
  ...
  **Measured 2026-08-28: 90 of 90 days agree, zero mismatches.** If this grows a
  ...
  The read is explicitly `.limit(1500)` (YTD measured 635 rows) and sets
