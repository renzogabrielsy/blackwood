...
### PERF-1 · Whole-history loads · map-only · M–L
...
### PERF-2 · Monster client components · ✓ VERIFIED · L (ongoing)
...
### PERF-3 · Non-transactional N+1 bulk mutations · map-only · M
...
### PERF-4 · Confirm `jspdf` is dynamically imported · ✓ found static import · S
